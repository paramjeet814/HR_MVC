...
namespace HRMVC.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public CustomersController(HRMVCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Customerid,Name,Email,Contact,Qualification")] Customer customer)
        {
